        ...
        <v-dialog v-model="dialog" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-card>
                <v-toolbar dark color="primary">
                    ...
                    <v-toolbar-title>Modifier {{menu.nom}}!</v-toolbar-title>
                    <v-spacer></v-spacer>
                    <v-toolbar-items>
                        <app-safeplat :canBeSafe="true" :plat="menu" action="Ajouter" @save="save"></app-safeplat>
                        <app-deletemenu @close="dialog = false" :menu="menu"></app-deletemenu>
                    </v-toolbar-items>
                </v-toolbar>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="3">
                            <v-img :src="menu.picture"></v-img>
                            <v-file-input
                                    :rules="rules"
                                    accept="image/png, image/jpeg, image/bmp"
                                    placeholder="Modifer cette image ?"
...
<script>
    ...
    methods:{
        ...
        save:function(){
            ...
            //this.menu.toFirebase('UPDATE_MENU');
    ...
    created:function(){
        this.solo = this.menu.toString();
        this.platName = this.menu.nom;
        this.platPrix=this.menu.prix;
    }
    }
